...
public class TransaccionRestController {
    ...
    public List<TransaccionVo> obtenerTodas(@PathVariable Long idUsuario, @PathVariable String moneda) {
        ...
        transacciones.add(new TransaccionVo(new Transaccion(1L, moneda, new Date(), new BigDecimal("33.0"), new BigDecimal("3.55"), TipoTransaccion.COMPRA)));
        transacciones.add(new TransaccionVo(new Transaccion(2L, moneda, new Date(), new BigDecimal("20.0"), new BigDecimal("3.55"), TipoTransaccion.VENTA)));
        transacciones.add(new TransaccionVo(new Transaccion(3L, moneda, new Date(), new BigDecimal("15.0"), new BigDecimal("3.55"), TipoTransaccion.COMPRA)));
